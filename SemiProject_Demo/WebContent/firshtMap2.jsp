			...
			$('#calendar').fullCalendar(
					{
						...
						select : function(startDate, endDate) {
							...
							myEndDate = endDate.format();
							myTitle = $("#tmpPlace").val();
							
							if (startDate.isValid() & endDate.isValid()) {
								var insert = $('#calendar').fullCalendar('renderEvent', {
									title : myTitle,
									start : startDate,
									end : endDate,
									allDay : true,
					...
					<div id="distancemap" style="width: 70%; height: 100%; margin: 0 auto;"></div>						
						<script>
						    ...
						    function searchPlaces(){
						    	...
						    	geocoder.addressSearch(searchplace,addressSearchCB);							    
							...
							<tbody id="my_tbody">								
								<tr>
									<td colspan="5" align="right">
										<input class="btn btn-primary btn-sm" type="button" value="삭제" onclick="row_del()">
